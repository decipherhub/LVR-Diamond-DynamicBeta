...
import gym
from Env import LVREnv

from PPO import PPO, ScaleToRange
...
def train():
    ...
    max_ep_len = 86400 // 12 * 10  # max timesteps in one episode
    ...
    checkpoint_path = directory + "PPO_{}_{}_{}_{}.pth".format(
        env_name, random_seed, run_num_pretrained, run_num
    )
    ...
    ################# training procedure ################
    # pre_traned_model = nn.Sequential(
    #     nn.Linear(1, 64),
    #     nn.ReLU(),
    #     nn.Linear(64, 128),
    #     nn.ReLU(),
